...
export class CommentService {
  ...
  async getVideoComments(
    ...
    try {
      ...
      return await apiClient.get<Comment[]>(`/videos/${videoId}/comments`, params);
    } catch (error) {
   ...
   */
  async addComment(videoId: string, commentData: CommentRequest): Promise<Comment> {
    try {
      return await apiClient.post<Comment>(`/videos/${videoId}/comments`, commentData);
    } catch (error) {
